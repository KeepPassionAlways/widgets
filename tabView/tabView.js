...
(function(exports, doc, win) {
	 ...
	 * processbar - 进度条 {Boolean} 默认为false
	 * activeCls - 高亮样式
	...
	TabView.prototype.screenMove = function(itemClick) {
		...
		doc.addEventListener('touchend', function(e) {
			...
			if(isMove) {
				elBody.style.transition = ".6s ease transform";
	...
	TabView.prototype.transfrom = function(dom, translate) {
		dom.style.transform = "translate3d(" + translate + "px,0,0)";
